    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="quiz.php"><span>Quiz</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a></li>
    ...
    <section id="services" class="services sections-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2> Answer these questions to test your understanding. Good luck!</h2>
        </div>
        ...
        <!-- paling penting   -->
            ...
            <script src="impact/assets/js/smscript.js"></script>
...
<script src="assets/js/smscript.js"></script>
