...
<head>
  ...
  <title>Choose 'YouTube Kids' and Disable 'Auto-Play' Button </title>
        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>Choose 'YouTube Kids' and Disable 'Auto-Play' Button</h2>
      ...
      <nav>
        <div class="container">
          <ol>
            ...
            <li>Choose 'YouTube Kids' and Disable 'Auto-Play' Button</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Breadcrumbs -->
        ...
        <div class="position-relative h-100">
          <div class="slides-1 portfolio-details-slider swiper">
            ...
            <div class="swiper-slide">
                <img src="image/yt1.png" alt="">
              </div>

              <div class="swiper-slide">
                <img src="image/yt2.jpg" alt="">
              </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              <h2>Choose 'YouTube Kids' and Disable 'Auto-Play' Button</h2>
              <p>
              Another good approach to have a safe search on Internet is by using Youtube Kids along with disable the auto-play function.
              </p>
              <p>
              How to apply or enable it? Follow these simple steps and you're good to go.</p>
              <p>
              ...
              <ul>
                <li>1. Open YouTube app.</li>
                <li>2. Tap on the right icon of the app.</li>
                <li>3. Click on the YouTube Kids app and install it.</li>
              </ul>

              <p>
                After finish setting up the YouTube Kids app, let's have a look on a feature which can prevent next video from playing.              </p>
              <p>
              <p class="fst-italic">
                How to disable 'Auto-Play' button: 
              </p>
              <ul>
                <li>1. Open YouTube Kids app.</li>
                <li>2. Go to the watch screen of any video.</li>
                <li>3. At the top of the video player, tap the Autoplay switch to set it to Off .</li>
              </ul>
            ...
            <div class="portfolio-info">
              <h3>Reference</h3>
              <ul>
                <li>Set up YouTube Kids account for your child. Guidebooks. https://guidebooks.google.com/family-link/manage-apps/youtube-kids?hl=en</li>
