        ...
        <!--  <div class="col-lg-6">
          ...
          <!--<div class="col-lg-6">-->
            <div class="content ps-0 ps-lg-5">
              ...
              <ul>
                <li><i class="bi bi-check-circle-fill"></i>This is the time to let the child play while putting on our parenting hats to establish a solid bond with them.
                                                           During these formative years, a child is constantly influenced by their environment and picks up knowledge through observation.</li>
                <li><i class="bi bi-check-circle-fill"></i>More than anybody else, children copy their parents.
                                                           Check to see if you, your spouse, or a carer acted similarly in front of your child if you notice any undesirable behaviour in your child.</li>
                <li><i class="bi bi-check-circle-fill"></i>These years serve as the foundation from which the relationship with them develops.
                                                          The subsequent years will be considerably simpler if this is really firm.
                                                          The following years will be more difficult if this foundation does not form properly.</li>
              </ul>
              <p>
              </p>

              <div class="position-relative mt-4">
                <img src="image/1to7.jpg" class="img-fluid rounded-4" alt="">
