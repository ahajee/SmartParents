        ...
        <div class="row gy-4 posts-list">
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="image/monitor.jpg" alt="" class="img-fluid">
              </div>


              <h2 class="title">
                <a href="7monitorplaygames.php">Monitor The Playing Games</a>
              </h2>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <h2 class="title">
                <a href="7youtubekids.php">Choose YouTube Kids</a>
              </h2>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="image/clock.png" alt="" class="img-fluid">
              </div>

             <!-- <p class="post-category">Social Engineering, Phishing</p>-->

              <h2 class="title">
                <a href="7limittimegames.php">Limit Time Playing Games</a>
              </h2>
