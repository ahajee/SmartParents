...
<head>
  ...
  <title>Monitor Your Children's Gaming Activities </title>
        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>Monitor Your Children's Gaming Activities</h2>
      ...
      <nav>
        <div class="container">
          <ol>
            ...
            <li>Monitor Your Children's Gaming Activities</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Breadcrumbs -->
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              <h2>Monitor Your Children's Gaming Activities</h2>
              <p>
              Children and games cannot separated each other. Most children love video games. They are always wanting to play and explore new things in the technology. 
              They are prone to these techonlogies making it 'necessary to play' even for a little while each day.
              
              </p>
              <p>
              Instead of letting your children playing freely without any supervision, you can sit watch them carefully during they use computers or mobile devices.
              This is a good approach to join them together while maintaining their safety to not click on any link easily. Let's always be with the during the playtime so they get to know new things.              </p>
              </p>
              <p>
              ...
              <div class="testimonial-item">
                <p>
                  ...
                  70% of families have at least one child who plays video games. Mobile is becoming a critical segment of the game industry.
                  <i class="bi bi-quote quote-icon-right"></i> - Entertainment Software Association
                </p>
                <div>
              ...
              Start to play with them whenever they want to play games. Along with it, they can get some exposure of the benefits of those games.
             </p>
            ...
            <div class="portfolio-info">
              <h3>Reference</h3>
              <ul>
                <li>Buku_Panduan_Keibubapaan_Siber_BM.pdf</li>
