          ...
          <div class="slides-1 portfolio-details-slider swiper">
            <div class="swiper-wrapper align-items-center">
              ...
              <div class="swiper-slide">
                <img src="image/fakcon.png" alt="">
              </div>

              <div class="swiper-slide">
                <img src="image/fakecont.png" alt="">
              </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              <h2>Put a Stop to Fake News</h2>
              <p>
              Due to reliance on social media as the primary source of information, it may lead to misinformation in the long term. 
              This is because sometimes posts on social media do not have solid source and fact. People keep sharing without a solid base which leads to misinformation. 
        Because of that, it is our responsibility to stop spreading news and information without solid sources and report to the 
        responsible body. For example in Malaysia is the Malaysian Communications And Multimedia Commission (MCMC). 
              ...
              <div class="testimonial-item">
                <p>
                  ...
                  <i class="bi bi-quote quote-icon-right"></i> -(al-Azhab 33:70)
                </p>
                <div>
              ...
              <div>
                 <p>
                    It is mentioned that we should be mindful of what we say and share to others and make sure that it is the right thing.
                    This is to avoid misinformation and wrong words from spreading. 
                </p>
                </div>
              <div class="testimonial-item">
                <p>
                  ...
                  <i class="bi bi-quote quote-icon-right"></i> -(al-Hujurat 49:6)
                </p>
                <div>
              ...
              <p>
              The Quran has mentioned about stop spreading talks and information regarding false news to others. 
              <p>
              As to that, it is our responsibility to check the source and legitness of the news we consume and the news we want to share.</p>
              <p>
            ...
            <div class="portfolio-info">
              <h3>Reference</h3>
              <ul>
                <li>Jaafar, S. (n.d.). The Islamic Moral System: Tafsir - commentary of Surah Al-Hujarat (49). The Sin Of Making Up Rumours. https://www.al-islam.org/islamic-moral-system-tafsir-commentary-surah-al-hujarat-49-jafar-subhani </li>
              </ul>
            </div>
          </div>
