        ...
        <div class="row gy-4 posts-list">
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="image/cyberbully.jpeg" alt="" class="img-fluid">
              </div>


              <h2 class="title">
                <a href="8dangercyberbully.php">Share Information With Children About The Dangers of Cyberbullying and How to Deal With It</a>
              </h2>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="image/ytk.jpg" alt="" class="img-fluid">
              </div>

              <h2 class="title">
                <a href="8dontuploadwithoutpermission.php">Do Not Allow Them to Upload Personal Information Without Parents' Supervision</a>
              </h2>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="image/safe.png" alt="" class="img-fluid">
              </div>

             <!-- <p class="post-category">Social Engineering, Phishing</p>-->

              <h2 class="title">
                <a href="8safebrowsing.php">Use Safe Browsing To Stay Safe Online</a>
              </h2>
