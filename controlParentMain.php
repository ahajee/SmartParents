...
<head>
  ...
  <title>Threats to Parents</title>
    ...
    <div class="breadcrumbs">
        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>Controls</h2>
              <p>Understand the controls that can be applied to prevent the threats.</p>
            </div>
          </div>
        </div>
      </div>
      <nav>
        <div class="container">
          <ol>
            <li><a href="index.php">Home</a></li>
            <li>Controls</li>   <!--navi after Home --!>
          </ol>
        </div>
      </nav>
    </div><!-- End Breadcrumbs -->
        ...
        <div class="row gy-4 posts-list">
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="image/parent2.jpg" alt="" class="img-fluid">
              </div>


              <h2 class="title">
                <a href="controlOneParent.php">Protect Your Family from Unwanted Attention</a>
              </h2>
              <p class="post-category">Know what is acceptable to be posted and what is not.</p>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="image/nofraud.jpg" alt="" class="img-fluid">
              </div>

              <h2 class="title">
                <a href="controlTwoParent.php">Online Scam and Fraud Prevention</a>
              </h2>
              <p class="post-category">What can be done to avoid getting involve with online scam and fraud.</p>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="image/news.jpg" alt="" class="img-fluid">
              </div>

             <!-- <p class="post-category">Social Engineering, Phishing</p>-->

              <h2 class="title">
                <a href="controlThreeParent.php">Put a Stop to Fake News</a>
              </h2>
              <p class="post-category">'Sharing a lie makes you a liar'-Telekom Malaysia, 2018</p>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <p class="post-category">Personal Data Leakage</p>

              <h2 class="title">
                <a href="blog-details.html">An exposure to data theft</a>
              </h2>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <p class="post-category">Other threats</p>

              <h2 class="title">
                <a href="blog-details.html">Some other information on cyber threats to parents</a>
              </h2>
