    ...
    <div class="breadcrumbs">
      ...
      <nav>
        <div class="container">
          <ol>
            <li><a href="index.php">Home</a></li>
            <li><a href="threatchildmain.php">Threats for Children</a></li>
        ...
        <div class="row gy-4 posts-list">
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <h2 class="title">
                <a href="7disclosurerandomgames.php">Disclosure of Any Random Games</a>
              </h2>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <h2 class="title">
                <a href="7inappropriatevideo.php">Inappropriate Video Content </a>
              </h2>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
             ...
             <!-- <p class="post-category">Social Engineering, Phishing</p>-->
              ...
              <h2 class="title">
                <a href="7IGD.php">Too Much Gametime Causing Internet Gaming Disorder</a>
              </h2>
