...
<head>
  ...
  <title>15 Years Old and Above</title>
        ...
        <div class="row gy-4 posts-list">
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="image/fam.jpg" alt="" class="img-fluid">
              </div>


              <h2 class="title">
                <a href="15familyactivities.php">Opt for Family Activities</a>
              </h2>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="image/sexual.jpg" alt="" class="img-fluid">
              </div>

              <h2 class="title">
                <a href="15shareinformation.php">Share Information on Sexual Grooming</a>
              </h2>
