  ...
  <main id="main">
    ...
    <div class="breadcrumbs">
      ...
      <nav>
        <div class="container">
          <ol>
            <li><a href="ThreatParentMain.php">Threat</a></li>
      ...
      <div class="container" data-aos="fade-up">
          ...
          <div class="slides-1 portfolio-details-slider swiper">
            <div class="swiper-wrapper align-items-center">
             ...
             <!-- <div class="swiper-slide">
              ...
              <div class="swiper-slide">
                <img src="image/sm1.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="image/sm2.jpg" alt="">
              </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          "Any addiction is defined by the inability to stop repeated or prolonged use despite continued negative consequences," says Clifford Sussman M.D., a child and adolescent psychiatrist based in Washington, D.C., who treats people of all ages with excessive screen time-related issues. "The severity is related to the dysfunctionality of the negative consequences. Therefore, phone and social media addiction are not defined by the total hours or frequency of use, but rather the negative impacts."
              ...
              <p>
              <strong>How social media addiction can affect children:</strong>

              <br>   Social media can have a serious impact on children’s psychology, behaviour, self-perception and their mental health across the board. <br>  <br>   1. Increased stress.
           <br>   2. Increased anxiety 
           <br>   3. Sensations of loneliness. 
           <br>   4. A distorted or negative self-image, particularly with regard to body image.
            </p>
           ...
           <br>   4. The 'Parental Control' toolbar, which you may add to the Explorer browser, will assist you in regulating the content by blocking particular adult websites.
            ...
            <div class="portfolio-info">
              ...
              <ul>
                <li>
                Social Media Addiction. Addiction Center. https://www.addictioncenter.com/drugs/social-media-addiction/
              </li>
              </ul>
            </div>
          </div>
