    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><p> <a href="Admin_index.php?logout='1'" style="color: red;">logout</a> </p></li>
        </ul>
      </nav><!-- .navbar -->
        ...
        <div class="row gy-4" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item  position-relative">
              ...
              <h3>Manage Users</h3>
              <a href="Admin_usermng.php" class="readmore stretched-link">Start<i class="bi bi-arrow-right"></i></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item position-relative">
              ...
              <h3>Manage Forum</h3>
              <a href="Admin_forumMng.php" class="readmore stretched-link">Start<i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
