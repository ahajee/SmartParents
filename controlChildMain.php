...
<head>
  ...
  <title>Controls to Children</title>
    ...
    <div class="breadcrumbs">
        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>Controls to Children</h2>
              <p>Learn how to address the threats to protect your family.</p>
            </div>
          </div>
        </div>
      </div>
      <nav>
        <div class="container">
          <ol>
            <li><a href="index.php">Home</a></li>
            <li><a href="controlChildMain.php">Controls to Children</a></li>
        ...
        <div class="row gy-4 posts-list">
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="image/tm1.jpg" alt="" class="img-fluid">
              </div>


              <h2 class="title">
                <a href="cover17cont.php">1 - 7 Years Old Children</a>
              </h2>
              <p class="post-category">Parents play with their children</p>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="image/tm2.png" alt="" class="img-fluid">
              </div>

              <h2 class="title">
                <a href="cover814cont.php">8 - 14 Years Old </a>
              </h2>
              <p class="post-category">Parents start to teach their children to stay safe online</p>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="image/mt3.jpg" alt="" class="img-fluid">
              </div>

             <!-- <p class="post-category">Social Engineering, Phishing</p>-->

              <h2 class="title">
                <a href="cover15cont.php">15 Years Old and Above</a>
              </h2>
              <p class="post-category">Introduce them a real cyber world </p>
