    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
		...
		<li><a href="Admin_index.php">Home</a></li>
          <li><a href="Admin_usermng.php">Users</a></li>
          <li><a href="Admin_forumMng.php">Forum</a></li>
		  <li><p> <a href="Admin_createUser.php?logout='1'" style="color: red;">logout</a> </p></li>
        </ul>
      </nav><!-- .navbar -->
...
<form method="post" action="Admin_createUser.php">
...
<div class="form-group">
	...
	<input type="password" class="form-control" id="exampleFormControlInput1" name="password_1">
</div>
<div class="form-group">
	<label for="exampleFormControlInput1">Confirm password</label>
	<input type="password" class="form-control" id="exampleFormControlInput1" name="password_2">
</div><br>
<div class="form-group">
	<button type="submit" class="btn btn-success" name="reg_user"> + Create user</button>
</div>
</form>
</body>
	</div>
