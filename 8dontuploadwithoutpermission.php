...
<head>
  ...
  <title>Do Not Allow Them to Upload Personal Information Online Without Parents' Supervision </title>
        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>Do Not Allow Them to Upload Personal Information Online Without Parents' Supervision</h2>
      ...
      <nav>
        <div class="container">
          <ol>
            ...
            <li>Do Not Allow Them to Upload Personal Information Online Without Parents' Supervision</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Breadcrumbs -->
        ...
        <div class="position-relative h-100">
          <div class="slides-1 portfolio-details-slider swiper">
            ...
            <div class="swiper-slide">
                <img src="image/share1.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="image/share2.jpg" alt="">
              </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              <h2>Do Not Allow Them to Upload Personal Information Online Without Parents' Supervision</h2>
              <p>
              Any personal information is important no matter what type of information it is. 
              For children, keeping personal information secure can guarantee their safety from being exposed to other strangers such as groomers.</p>
              But how to keep personal information secure and safe?<p>
              <p>
              ...
              <ul>
                <li>1. Know who you share information with.</li>
                <li>2. Question any situation where your children will be sharing their personal information. Do not give out your personal information to any stranger.</li>
                <li>3. Telling them that sharing personal information can lead to other problems such as cyberbully.</li>
              </ul>
            ...
            <div class="portfolio-info">
              <h3>Reference</h3>
              <ul>
                <li>Protecting Your Personal Information.Edamerica. https://edrepay.com/money-basics/protecting-your-personal-information#:~:text=There%20is%20nothing%20more%20important,and%20other%20important%20personal%20records.</li>
