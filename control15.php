        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>Threats to Children (15 Years Old and Above)</h2>
              <p>.....</p>
            </div>
          </div>
        </div>
        ...
        <div class="row gy-4 posts-list">
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <h2 class="title">
                <a href="threatOneChild.php">Share information on the danger of sexual grooming online and meeting strangers</a>
              </h2>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <h2 class="title">
                <a href=".php">Advise and ask them to use strong password in every account</a>
              </h2>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <h2 class="title">
                <a href="blog-details.html"> Restrict them to not upload any pirate content to avoid any malware attack </a>
              </h2>
