...
if (isset($_POST['btnsbt'])) {
    ...
    $query = "INSERT INTO forum (topic,message, user_id) VALUES ('$topic','$message', '$user_id')";
    mysqli_query($db, $query);
    header('Location: forum.php');
    exit();
}

// Fetch all posts with associated username from the database
$query = "SELECT forum.topic, forum.message, users.username FROM forum INNER JOIN users ON forum.user_id = users.user_id";
...
<body>
  ...
  <div class="form-group">
<br><input type="submit" name="btnsbt"
class="btn btn-success" value="POST"></input>
</div>
</form>
</body>
</div>
