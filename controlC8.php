...
<head>
  ...
  <title>Control to Children</title>
        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>Control to Children (8-14 Years Old)</h2>
              <p>.....</p>
            </div>
          </div>
        </div>
      ...
      <nav>
        <div class="container">
          <ol>
            ...
            <li>Controls to Children</li>   <!--navi after Home --!>
          </ol>
        </div>
      </nav>
    </div><!-- End Breadcrumbs -->
        ...
        <div class="row gy-4 posts-list">
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <h2 class="title">
                <a href="threatOneChild.php">Do not allow them to upload personal information on profiles, blogs or websites without parents' supervision</a>
              </h2>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <h2 class="title">
                <a href=".php">Share information with children about the dangers of cyberbullying and how to deal with it</a>
              </h2>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <h2 class="title">
                <a href="blog-details.html"> Teach them to respect others while online and to think before uploading anything</a>
              </h2>
