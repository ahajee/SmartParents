    ...
    <section id="services" class="services sections-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>Quiz</h2>
          <p>Take some quiz to test you understanding of what your have read.</p>
        </div>
        ...
        <div class="row gy-4" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item  position-relative">
              ...
              <h3>Cyberbully</h3>
              <p></p>
              <a href="quizcybernew.php" class="readmore stretched-link">Take Quiz<i class="bi bi-arrow-right"></i></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item position-relative">
              ...
              <h3>Online games</h3>
              <p></p>
              <a href="quizog.php" class="readmore stretched-link">Take Quiz <i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item position-relative">
              ...
              <h3>Social Media</h3>
              <p></p>
              <a href="quizsm.php" class="readmore stretched-link">Take Quiz <i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
