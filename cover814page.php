        ...
        <div class="row gy-4 posts-list">
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="image/unfiltered.jpg" alt="" class="img-fluid">
              </div>


              <h2 class="title">
                <a href="8exposureviolent.php">Exposure to Violent and Sexual Content</a>
              </h2>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <h2 class="title">
                <a href="8cyberbully.php">Cyberbully </a>
              </h2>
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="image/unfilter.jpg" alt="" class="img-fluid">
              </div>

             <!-- <p class="post-category">Social Engineering, Phishing</p>-->

              <h2 class="title">
                <a href="8unfiltered.php">Unfiltered Internet Browsing</a>
              </h2>
