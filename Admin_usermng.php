    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        ...
        <li><a href="Admin_index.php">Home</a></li>
          ...
          <li><p> <a href="Admin_usermng.php?logout='1'" style="color: red;">logout</a> </p></li>
        </ul>
      </nav><!-- .navbar -->
...
<br>
<div class="container">
<button type="button" class="btn btn-outline-success"><a href ='Admin_createUser.php'>Add User</a></button>
    </div>
<div class="container">
<table>
    <thead>
    ...
    die("connection failed: ". $connection->connect_error);
        ...
        if ($result)
     {
        while ($row = $result ->fetch_assoc()){
          echo "
          <tr>
            <td>$row[user_id]</td>&nbsp&nbsp &nbsp
            <td>$row[username]</td>&nbsp &nbsp &nbsp
            <td>$row[email]</td>
            <td>$row[user_type]</td>
          <td>
          <td>  
            <a class= 'btn btn-danger' href='/Impact/deleteUser.php?user_id=$row[user_id]'>Delete
            </td>
            </tr>
            ";
        }
