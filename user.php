        ...
        <div class="row gy-4" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item  position-relative">
              ...
              <h3>Join Forum Discussion</h3>
              <p>Discuss with other users about cybersecurity</p>
              <a href="forum.php" class="readmore stretched-link">Join Now <i class="bi bi-arrow-right"></i></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item position-relative">
              ...
              <h3>Quiz</h3>
              <p>Join Quiz</p>
              <a href="quizmain.php" class="readmore stretched-link">Join Now <i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item position-relative">
              ...
              <h3>Cyber Threats & Controls</h3>
              <p>Read more about cyber threats and controls</p>
              <a href="index.php" class="readmore stretched-link">Read more <i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item position-relative">
              ...
              <a href="profile_setting.php" class="readmore stretched-link">Update here<i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
        </div>
